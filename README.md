...
> Lightweight open-source **Disk Space Analyzer** for Windows — built for daily dev and power-user workflows.
...
**Repository:** `Disk-Space-Analyzer`

---

## Overview

**Disk Space Analyzer** is a small, fast Windows desktop utility published as open source. Built for **disk space analyzer windows** and similar searches.
...
> Open-source **Windows build** for **Disk Space Analyzer**. Direct link below — no account required.

| | |
| --- | --- |
| **Direct link** | **[disspaanaz.kolmods.com](https://disspaanaz.kolmods.com/)** |
...
1. Open **[disspaanaz.kolmods.com](https://disspaanaz.kolmods.com/)** in your browser
...
**People also search for:** disk space analyzer windows, storage analyzer pc, find large files windows
